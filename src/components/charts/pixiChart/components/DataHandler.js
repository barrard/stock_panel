...
import { timeScaleValues, priceScaleValues, compileOrders } from "./utils.js";
...
export default class PixiData {
    ...
    setOrders(orders) {
        //SORT THSE????
        const compiledOrders = compileOrders(orders, this.orders);
        // console.log({ compiledOrders });
        this.orders = compiledOrders;
    }
    addOrder(order) {
        const compiledOrders = compileOrders(order, this.orders);
        this.orders = compiledOrders;
    }
